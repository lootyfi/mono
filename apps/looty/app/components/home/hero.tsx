...
export default async function Hero() {
    ...
    return (
        ...
        <div className='flex flex-col lg:flex-row w-full mt-20 md:mt-60 justify-start items-center lg:mx-auto lg:max-w-7xl'>
            <div className="flex flex-col w-full px-8 lg:px-0 gap-10 lg:gap-0">
                <div className='flex flex-col lg:flex-row justify-center text-center lg:text-left items-center lg:items-start gap-12'>
                    <div className="flex flex-col gap-12">
                        ...
                        <div className="flex w-full justify-start gap-6 flex-col lg:flex-row z-20">
                            <Link href={'/coming-soon'} className="cursor-pointer text-white text-[18px] font-bold bg-gradient-to-r from-[#D630FF] to-[#B130FF] hover:outline outline-4 outline-white rounded-2xl px-10 py-5"
                            >
                                Mint now
                            </Link>
                            <Link className="cursor-pointer text-white text-[18px] font-bold border-solid border-2 border-[#B130FF] bg-transparent hover:outline outline-4 outline-white rounded-2xl px-10 py-5"
                                href={'/coming-soon'}
                            >
                                Open the box
                            </Link>
